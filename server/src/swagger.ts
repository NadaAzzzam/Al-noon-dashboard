...
function buildPaths() {
  ...
  paths["/api/settings/promo-image"] = {
    post: {
      ...
      tags: ["Settings"],
      summary: "Upload promo image (Admin) [Deprecated: use /upload-media?type=promo]",
      security: [{ bearerAuth: [] }],
      requestBody: { content: { "multipart/form-data": { schema: { type: "object", properties: { image: { type: "string", format: "binary" } } } } } },
      responses: {
        "200": { description: "Image URL", ...refSchema("SingleUrlResponse") },
  ...
  paths["/api/settings/upload-media"] = {
    post: {
      operationId: "uploadHomePageMedia",
      tags: ["Settings"],
      summary: "Upload home page media (image or video) with auto-detection (Admin)",
      ...
      security: [{ bearerAuth: [] }],
      parameters: [
        { name: "type", in: "query", schema: { type: "string", enum: ["hero", "section", "collection", "promo"], default: "section" }, description: "Media type/section context" },
      ],
      requestBody: { content: { "multipart/form-data": { schema: { type: "object", properties: { file: { type: "string", format: "binary", description: "Image or video file" } } } } } },
      responses: {
        "200": { description: "Image or video URL", ...refSchema("SingleUrlResponse") },
        "400": errDesc("No file uploaded or invalid file"),
        "401": errDesc("Unauthorized"),
        "403": errDesc("Forbidden"),
      },
    },
  ...
  components: {
    ...
    schemas: {
      ...
      HomeCollectionInput: {
        ...
        required: ["titleEn", "titleAr", "image", "url", "order"],
        properties: {
          titleEn: { type: "string", minLength: 1, description: "Title (English)" },
          titleAr: { type: "string", minLength: 1, description: "Title (Arabic)" },
          image: { type: "string", minLength: 1, description: "Default image URL (required)" },
          hoverImage: { type: "string", maxLength: 2000, description: "Hover image URL (optional)" },
          video: { type: "string", maxLength: 2000, description: "Default video URL (optional)" },
          hoverVideo: { type: "string", maxLength: 2000, description: "Hover video URL (optional)" },
          defaultMediaType: { type: "string", enum: ["image", "video"], description: "Default card media type (optional, defaults to image)" },
          hoverMediaType: { type: "string", enum: ["image", "video"], description: "Hover card media type (optional, defaults to image)" },
          url: { type: "string", minLength: 1, maxLength: 2000, description: "Link URL" },
          order: { type: "integer", minimum: 0, description: "Display order" },
          categoryId: { type: "string", description: "Optional category reference" },
        },
      },
      HomeCollectionOutput: {
        ...
        properties: {
          ...
          image: { type: "string", description: "Default image URL" },
          hoverImage: { type: "string", description: "Hover image URL", nullable: true },
          video: { type: "string", description: "Default video URL", nullable: true },
          hoverVideo: { type: "string", description: "Hover video URL", nullable: true },
          defaultMediaType: { type: "string", enum: ["image", "video"], description: "Default card media type" },
          hoverMediaType: { type: "string", enum: ["image", "video"], description: "Hover card media type" },
          url: { type: "string", description: "Link URL" },
          order: { type: "integer", description: "Display order" },
          categoryId: { type: "string", description: "Optional category ID", nullable: true },
        },
      },
      ProductCategoryRef: {
        type: "object",
                ...
                properties: {
                  store: {
                    ...
                    properties: {
                      ...
                      comingSoonMode: { type: "boolean", description: "When true, storefront should show coming-soon page" },
                      comingSoonMessage: { type: "object", properties: { en: { type: "string" }, ar: { type: "string" } }, description: "Optional message on coming-soon page" },
                      underConstructionMode: { type: "boolean", description: "When true, storefront should show under-construction page" },
                      underConstructionMessage: { type: "object", properties: { en: { type: "string" }, ar: { type: "string" } }, description: "Optional message on under-construction page" },
                    },
                  },
                  ...
                  homeCollections: { type: "array", items: { $ref: "#/components/schemas/HomeCollectionOutput" }, description: "Home page collections/categories. Duplicates by url are deduplicated (first occurrence kept)." },
            ...
            properties: {
              settings: {
                ...
                properties: {
                  ...
                  quickLinks: { type: "array", items: { type: "object", properties: { label: { type: "object" }, url: { type: "string" } } }, description: "Footer quick links" },
                  socialLinks: { type: "object", properties: { facebook: { type: "string" }, instagram: { type: "string" } } },
                  newsletterEnabled: { type: "boolean" },
                  discountCodeSupported: { type: "boolean", description: "Whether discount codes are enabled at checkout" },
                  hero: { type: "object", description: "Hero section: images, videos, title, subtitle, CTA label and URL" },
                  heroEnabled: { type: "boolean" },
                  newArrivals: { type: "array", items: { type: "object" }, description: "New arrival products (no duplicate media arrays when properly cleaned)" },
                  homeCollections: { type: "array", items: { $ref: "#/components/schemas/HomeCollectionOutput" }, description: "Home page collections (deduplicated by url)" },
                  feedbackSectionEnabled: { type: "boolean" },
                  feedbackDisplayLimit: { type: "integer", minimum: 0, maximum: 50 },
                  feedbacks: { type: "array", items: { type: "object" }, description: "Customer feedbacks (single message field, no duplicate comment)" },
                  announcementBar: { type: "object", properties: { text: { type: "object" }, enabled: { type: "boolean" }, backgroundColor: { type: "string" } } },
                  promoBanner: { type: "object", properties: { enabled: { type: "boolean" }, image: { type: "string" }, title: { type: "object" }, subtitle: { type: "object" }, ctaLabel: { type: "object" }, ctaUrl: { type: "string" } } },
                  featuredProductsEnabled: { type: "boolean" },
                  featuredProductsLimit: { type: "integer", minimum: 1, maximum: 24 },
                  contentPages: { type: "array", items: { type: "object", properties: { slug: { type: "string" }, title: { type: "object" }, content: { type: "object" } } } },
                  orderNotificationsEnabled: { type: "boolean" },
                  orderNotificationEmail: { type: "string", format: "email" },
                  aiAssistant: { type: "object", properties: { enabled: { type: "boolean" }, geminiApiKey: { type: "string" }, assistantName: { type: "string" }, greeting: { type: "object" }, systemPrompt: { type: "string" }, suggestedQuestions: { type: "array", items: { type: "object" } } } },
                  currency: { type: "string", example: "EGP" },
                  currencySymbol: { type: "string", example: "LE" },
                  instaPayNumber: { type: "string", description: "InstaPay number for payments" },
                  paymentMethods: { type: "object", properties: { cod: { type: "boolean" }, instaPay: { type: "boolean" } } },
                  lowStockThreshold: { type: "integer", minimum: 0 },
                  stockInfoThreshold: { type: "integer", minimum: 0 },
                  ...
                  underConstructionMessage: { type: "object", properties: { en: { type: "string" }, ar: { type: "string" } }, description: "Optional message on under-construction page" },
                  seoSettings: { type: "object", description: "SEO default meta (defaultMetaDescription, defaultMetaKeywords, ogImage, twitterCard, homePageMeta, catalogPageMeta, productPageMeta)" },
                },
              },
            },
          },
