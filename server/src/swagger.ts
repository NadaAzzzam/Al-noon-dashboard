          ...
          "application/json": {
            schema: {
              ...
              properties: {
                ...
                homeCollections: { type: "array", items: { type: "object" }, maxItems: 20, description: "Collections with deduplication by url" },
            ...
            properties: {
              settings: {
                ...
                properties: {
                  ...
                  homeCollections: { type: "array", items: { type: "object", properties: { title: { type: "object" }, image: { type: "string" }, hoverImage: { type: "string" }, video: { type: "string" }, url: { type: "string" }, order: { type: "integer" }, categoryId: { type: "string" } } }, description: "Home page collections (deduplicated by url)" },
                  feedbackSectionEnabled: { type: "boolean" },
                  feedbackDisplayLimit: { type: "integer", minimum: 0, maximum: 50 },
