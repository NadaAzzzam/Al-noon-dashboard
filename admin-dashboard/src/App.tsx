    ...
    <Routes>
      ...
      >
        ...
        <Route
          path="cities"
          element={
            <RequirePermission permission="cities.view">
              <CitiesPage />
            </RequirePermission>
          }
        />
        <Route
          ...
          element={
            <RequirePermission permission="shipping_methods.view">
              <ShippingMethodsPage />
            </RequirePermission>
          }
        />
        ...
        <Route
          path="roles"
          element={
            <RequirePermission permission={["roles.view", "departments.manage"]}>
              <RolesPage />
            </RequirePermission>
          }
        />
        ...
        <Route
          path="contact"
          element={
            <RequirePermission permission="contact.view">
        ...
        <Route
          path="feedback"
          element={
            <RequirePermission permission="feedback.view">
              <FeedbackPage />
            </RequirePermission>
          }
        />
        <Route
          path="ai-chats"
          element={
            <RequirePermission permission="ai_chats.view">
              <AiChatHistoryPage />
            </RequirePermission>
          }
        />
